...
def language_model_loss(model: BaselineTinyGPT, idx, targets):
    logits = model(idx)
...
def generate_ids(model: BaselineTinyGPT, start_ids, max_new_tokens: int, temperature: float = 0.8, top_k: int = 20):
